...
def combine_csv_files():
    ...
    df1 = pd.read_csv('../attn_results/combined_results_repeated_06.11.2025.csv')
    df2 = pd.read_csv('../attn_results/combined_results_orig_06.11.2025.csv')
    ...
    df1['source_file'] = 'combined_results_repeated_06.11.2025.csv'
    df2['source_file'] = 'combined_results_orig_06.11.2025.csv'
